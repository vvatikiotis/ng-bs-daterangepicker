        ...
        return {
            ...
            link: function ($scope, $element, $attributes, ngModel) {
                ...
                if ($attributes.singleDatePicker == "true") {
                    ...
                    options.singleDatePickerDate = $attributes.singleDatePickerDate && $parse($attributes.singleDatePickerDate)($scope);
                }
                ...
                ngModel.$render = function () {
                    if (!ngModel.$viewValue || !ngModel.$viewValue.startDate || !ngModel.$viewValue.endDate) return;
